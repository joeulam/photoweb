      ...
      <main className="container mx-auto max-w-7xl px-6 pb-24 pt-32 relative z-10">
        ...
        <header className="mb-24 flex flex-col gap-8 md:flex-row md:items-end md:justify-between border-b border-zinc-800/50 pb-12 backdrop-blur-sm">
          ...
          >
            <h1 className="text-6xl font-bold leading-none tracking-tighter md:text-9xl relative">
              ...
              <span className="absolute -top-4 -left-4 text-xs font-mono text-yellow-400 opacity-50">+</span>
            </h1>
          </motion.div>
          ...
          >
            <p className="text-zinc-400 font-light leading-relaxed">
              A curated database of light, shadow, and architectural form. 
              Captured on digital and analog mediums.
            </p>
          </motion.div>
        </header>
        ...
        <div className="mb-6 flex items-end justify-between">
             <div className="flex items-center gap-2">
                ...
                <h2 className="text-sm font-mono uppercase tracking-widest text-zinc-500">Live Feed</h2>
             </div>
             <span className="text-[10px] font-mono text-zinc-700">INDEX: {photos.length}</span>
        </div>
